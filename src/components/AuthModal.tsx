  ...
  return <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-black border border-zinc-800 text-white">
        ...
        <div className="py-6 flex justify-center">
          <Button variant="outline" size="lg" onClick={handleSignIn} disabled={loading} className={cn("border-zinc-700 hover:bg-zinc-800 hover:text-white", "flex items-center justify-center w-full max-w-xs")}>
            {loading ? <>
